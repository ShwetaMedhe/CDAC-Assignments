...
public class EmployeeService {
   ...
   static {
	...
	public static double calculateNetSalaryById(String id) {
	    Employee e = searchById(id);
	    if(e != null) {
	        return e.calculateSal();  // Assuming this method is defined in Employee class and overridden in subclasses
	    }
